...
const SUBSIDIARIES = [
  {
    ...
    logo: "https://abubakarmall.com/wp-content/uploads/2026/03/Global-Trade-Solutions-Logo-copy-3.png",
  ...
  },
  {
    ...
    logo: "https://abubakarmall.com/wp-content/uploads/2026/03/ASM-C-last-%E2%9C%85-2048x1828.png",
    ...
    <>
      ...
      <style jsx global>{`
        ...
        .splash-logo {
          ...
          opacity: 0; animation: splashLogoIn 0.9s 0.05s cubic-bezier(0.22,1,0.36,1) both;
        }
        .splash-tag {
          font-family: var(--font-nav);
        ...
        .splash-fill {
          ...
          border-radius: 2px;
          animation: splashProgress 1.5s 0.05s cubic-bezier(0.4,0,0.2,1) forwards;
        }
